...
func (s BasicServerImpl) MtSimpleReply(ctx context.Context, args *StringArg) (resp *SimpleStringReply, err error) {
	...
	resp = &SimpleStringReply{Reply: args.Arg1}
	return
}
...
func (s BasicServerImpl) MtWithSubjectParams(ctx context.Context, mp1 string, mp2 string) (resp *SimpleStringReply, err error) {
	if mp1 != "p1" {
	...
	resp = &SimpleStringReply{Reply: "Hi"}
	return
}
