...
import (
	...
	github_com_wyy_go_wgo_nrpc "github.com/wyy-go/wgo/nrpc"
...
func (h *SvcCustomSubjectHandler) SetMiddleware(ms []nrpc.Middleware) {
	h.ms = ms
}
...
func (h *SvcCustomSubjectHandler) Handler(msg *nats.Msg) {
	...
	case "mtvoidreqstreamedreply":
		...
		var req github_com_wyy_go_wgo_nrpc.Void
		if err := nrpc.Unmarshal(request.Encoding, msg.Data, &req); err != nil {
...
func (c *SvcCustomSubjectClient) MtVoidReply(req StringArg) (err error) {
	...
	// call
	var resp github_com_wyy_go_wgo_nrpc.Void
	err = nrpc.Call(&req, &resp, c.nc, subject, c.Encoding, c.Timeout)
	if err != nil {
		return // already logged
	}
...
func (h *SvcSubjectParamsHandler) SetMiddleware(ms []nrpc.Middleware) {
	h.ms = ms
}
...
func (c *SvcSubjectParamsClient) MtNoReply() (err error) {
	...
	// call
	var req github_com_wyy_go_wgo_nrpc.Void
	var resp github_com_wyy_go_wgo_nrpc.NoReply
	err = nrpc.Call(&req, &resp, c.nc, subject, c.Encoding, c.Timeout)
	if err != nil {
		return // already logged
	}
...
func (h *NoRequestServiceHandler) SetMiddleware(ms []nrpc.Middleware) {
	h.ms = ms
}
